...
class Bank {
    ...
    public static class InterestCalculator {
        public static double calculateInterest(double principle, int years) {
            double totalRate = baseRate + 1.2;
            return (principle * years * totalRate) / 100;
        }
    }
}
...
public class prog_6_4 {
    public static void main(String[] args) {
        double interest = Bank.InterestCalculator.calculateInterest(5000, 3);
